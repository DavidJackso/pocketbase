	...
	scenarios := []tests.ApiScenario{
		...
		},
		{
			...
			ExpectedContent: []string{
				...
				`"fields":[{"autogeneratePattern":"[a-z0-9]{15}","help":"","hidden":false,"id":"text3208210256","label":"","max":15,"min":15,"name":"id","pattern":"^[a-z0-9]+$","presentable":false,"primaryKey":true,"required":true,"system":true,"type":"text"},{"autogeneratePattern":"","help":"","hidden":false,"id":"12345789","label":"","max":0,"min":0,"name":"test","pattern":"","presentable":false,"primaryKey":false,"required":false,"system":false,"type":"text"}]`,
			},
			ExpectedEvents: map[string]int{
				"*":                              0,
				"OnCollectionCreateRequest":      1,
		...
		},
		{
			...
			ExpectedContent: []string{
				...
				`{"autogeneratePattern":"","help":"","hidden":true,"id":"text2504183744","label":"","max":0,"min":10,"name":"tokenKey","pattern":"","presentable":false,"primaryKey":false,"required":true,"system":true,"type":"text"}`,
			},
			NotExpectedContent: []string{
				`"secret":"`,
			},
		...
		},
		{
			...
			ExpectedContent: []string{
				`"name":"new"`,
				`"type":"view"`,
				`"fields":[{"autogeneratePattern":"","help":"","hidden":false,"id":"text3208210256","label":"","max":0,"min":0,"name":"id","pattern":"^[a-z0-9]+$","presentable":false,"primaryKey":true,"required":true,"system":true,"type":"text"}]`,
			},
			ExpectedEvents: map[string]int{
				"*":                              0,
				"OnCollectionCreateRequest":      1,
