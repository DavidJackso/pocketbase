import{i as e}from"./index-C66B-mZu.js";import{t as n}from"./expandInfo-1Cvl3BQE.js";import{t as r}from"./fieldsInfo-Bb3XRIh7.js";import{fullDummyPayload as i,primitivesDummyPayload as a,replaceDummyPayloadPlaceholder as o}from"./docsCreate-94p_H9qv.js";function s(s){let c=app.utils.getApiExampleURL(),l=s.updateRule===null,u=s.type===`auth`?[`id`,`password`,`verified`,`email`,`emailVisibility`]:[`id`],d=s.fields?.filter(e=>!e.hidden&&e.type!=`autodate`&&!u.includes(e.name))||[],f={collectionId:s.id,collectionName:s.name},p=[{title:200,value:JSON.stringify(Object.assign(f,app.utils.getDummyFieldsData(s)),null,2)},{title:400,value:`
                {
                  "status": 400,
