import{i as e}from"./index-C66B-mZu.js";function n(n){let a=app.utils.getApiExampleURL(),o=[{title:()=>e.t(`api_preview.request_email_change`),content:r},{title:()=>e.t(`auth.confirm_email_change`),content:i}],s=store({activeActionIndex:0});return t.div({pbEvent:`apiPreviewEmailChange`,className:`content`},t.p(null,e.t(`api_preview.email_change_desc1`,{name:n.name})),t.p(null,e.t(`api_preview.email_change_desc2`)),app.components.codeBlockTabs({className:`sdk-examples m-t-sm`,historyKey:`pbLastSDK`,tabs:[{title:`JS SDK`,language:`js`,value:`
