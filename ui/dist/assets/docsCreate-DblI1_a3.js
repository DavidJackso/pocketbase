import{i as e}from"./index-D7rXdP5G.js";import{t as n}from"./expandInfo-Cj268jQJ.js";import{t as r}from"./fieldsInfo-B0cvYWwC.js";import"./filterSyntax-CLbEm5YG.js";function i(i){let c=app.utils.getApiExampleURL(),l=i.createRule===null,u=i.type===`auth`,d=u?[`password`,`verified`,`email`,`emailVisibility`]:[],f=i.fields?.filter(e=>!e.hidden&&e.type!=`autodate`&&!d.includes(e.name))||[],p={collectionId:i.id,collectionName:i.name},m=[{title:200,value:JSON.stringify(Object.assign(p,app.utils.getDummyFieldsData(i)),null,2)},{title:400,value:`
                {
                  "status": 400,
