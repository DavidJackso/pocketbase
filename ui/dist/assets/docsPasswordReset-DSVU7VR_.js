import{i as e}from"./index-C66B-mZu.js";function n(n){let a=app.utils.getApiExampleURL(),o=[{title:()=>e.t(`api_preview.request_password_reset`),content:r},{title:()=>e.t(`api_preview.confirm_password_reset_title`),content:i}],s=store({activeActionIndex:0});return t.div({pbEvent:`apiPreviewPasswordReset`,className:`content`},t.p(null,e.t(`api_preview.password_reset_desc1`,{name:n.name})),t.p(null,e.t(`api_preview.password_reset_desc2`)),app.components.codeBlockTabs({className:`sdk-examples m-t-sm`,historyKey:`pbLastSDK`,tabs:[{title:`JS SDK`,language:`js`,value:`
