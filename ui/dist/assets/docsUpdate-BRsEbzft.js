import{i as e}from"./index-D7rXdP5G.js";import{t as n}from"./expandInfo-Cj268jQJ.js";import{t as r}from"./fieldsInfo-B0cvYWwC.js";import{fullDummyPayload as i,primitivesDummyPayload as a,replaceDummyPayloadPlaceholder as o}from"./docsCreate-DblI1_a3.js";function s(s){let c=app.utils.getApiExampleURL(),l=s.updateRule===null,u=s.type===`auth`?[`id`,`password`,`verified`,`email`,`emailVisibility`]:[`id`],d=s.fields?.filter(e=>!e.hidden&&e.type!=`autodate`&&!u.includes(e.name))||[],f={collectionId:s.id,collectionName:s.name},p=[{title:200,value:JSON.stringify(Object.assign(f,app.utils.getDummyFieldsData(s)),null,2)},{title:400,value:`
                {
                  "status": 400,
