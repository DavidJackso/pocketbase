import{i as e}from"./index-C66B-mZu.js";function n(n){let r=app.utils.getApiExampleURL(),i={collectionId:n.id,collectionName:n.name},a=[{title:200,value:JSON.stringify([{status:200,body:Object.assign(i,app.utils.getDummyFieldsData(n))},{status:200,body:Object.assign(i,app.utils.getDummyFieldsData(n))}],null,2)},{title:400,value:`
                {
                  "status": 400,
