import{i as e}from"./index-C66B-mZu.js";import{t as n}from"./expandInfo-1Cvl3BQE.js";import{t as r}from"./fieldsInfo-Bb3XRIh7.js";import"./filterSyntax-t3JtlZ1e.js";function i(i){let c=app.utils.getApiExampleURL(),l=i.createRule===null,u=i.type===`auth`,d=u?[`password`,`verified`,`email`,`emailVisibility`]:[],f=i.fields?.filter(e=>!e.hidden&&e.type!=`autodate`&&!d.includes(e.name))||[],p={collectionId:i.id,collectionName:i.name},m=[{title:200,value:JSON.stringify(Object.assign(p,app.utils.getDummyFieldsData(i)),null,2)},{title:400,value:`
                {
                  "status": 400,
