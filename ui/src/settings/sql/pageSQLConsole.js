...
export function pageSQLConsole(route) {
    app.store.title = i18n.t("sql_console.title");
    ...
    async function executeSQLWithConfirm() {
        ...
        return app.modals.confirm(
            t.div(
                ...
                t.h6(
                    null,
                    i18n.t("sql_console.confirm_caution"),
                ),
            ),
            () => executeSQL(),
            null,
            { yesButton: i18n.t("sql_console.execute"), noButton: i18n.t("common.cancel") },
        );
    }
    ...
    async function executeSQL() {
        ...
        try {
            ...
            if (!err?.isAbort) {
                pageData.isExecuting = false;
                pageData.errorMsg = err?.response?.message || err?.message || i18n.t("sql_console.execute_failed");
            }
        }
    }
        ...
        t.div(
            ...
            t.header(
                    ...
                    t.button(
                        {
                            ...
                            ariaDescription: app.attrs.tooltip(i18n.t("sql_console.recently_executed"), "right"),
                ...
                t.div(
                    ...
                    t.button(
                        ...
                        t.span({ className: "txt" }, i18n.t("sql_console.execute")),
                    ),
                ),
            ),
            t.div(
            ...
            t.div(
                ...
                t.button(
                    ...
                    () => i18n.t("sql_console.caveats_title"),
                ),
                t.div(
                    {
                    ...
                    t.ul(
                        null,
                        t.li(null, i18n.t("sql_console.caveat_row_limit")),
                        t.li(null, i18n.t("sql_console.caveat_timeout")),
                        t.li(null, i18n.t("sql_console.caveat_byte_strings")),
                        t.li(null, i18n.t("sql_console.caveat_multiple_queries")),
                    ),
                ),
            ),
            // error alert
            ...
            t.div(
                ...
                t.p({ className: "txt-bold" }, i18n.t("sql_console.execute_success")),
                () => {
                            ...
                            if (!pageData.sortedResultRows.length) {
                                return t.tr(
                                    ...
                                    t.td(
                                        ...
                                        t.span({ className: "txt-hint" }, i18n.t("sql_console.no_rows_found")),
                                    ),
                                );
                            }
                    ...
                    () => {
                        ...
                        return [
                            ...
                            t.span({
                                role: "button",
                                className: "link-hint",
                                textContent: i18n.t("sql_console.export_csv"),
                                onclick: downloadCSV,
                            }),
                            ")",
                        ];
