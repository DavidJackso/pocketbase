...
function mailTestModal(preselectedCollectionIdOrName = "", template = "") {
    ...
    async function send() {
        ...
        testTimeoutId = setTimeout(() => {
            ...
            app.modals.close();
            app.toasts.error(i18n.t("mail_test.send_timeout"));
        }, 15000);
        ...
        try {
            ...
            app.toasts.success(i18n.t("mail_test.sent_success"));
    ...
    return t.div(
        ...
        t.header({ className: "modal-header" }, t.h5({ className: "m-auto" }, i18n.t("mail_test.title"))),
        t.form(
            {
                id: uniqueId,
            ...
            t.div(
                ...
                () => {
                    ...
                    return t.div(
                        ...
                        t.div(
                            { className: "field" },
                            t.label({ htmlFor: uniqueId + ".collection" }, i18n.t("mail_test.auth_collection")),
                            app.components.select({
                                ...
                                placeholder: () =>
                                    data.isAuthCollectionsLoading
                                        ? i18n.t("mail_test.loading_auth_collections")
                                        : i18n.t("mail_test.select_auth_collection"),
                                options: () =>
                ...
                t.div(
                    ...
                    t.div(
                        { className: "field" },
                        t.label({ htmlFor: uniqueId + ".email" }, i18n.t("mail_test.to_email")),
                        t.input({
                            id: uniqueId + ".email",
                            name: "email",
                            type: "email",
        ...
        t.footer(
            ...
            t.button(
                ...
                t.span({ className: "txt" }, i18n.t("common.send")),
            ),
        ),
    );
}
